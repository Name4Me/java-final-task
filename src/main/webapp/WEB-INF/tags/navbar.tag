        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown show">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        ...
                        <c:if test="${(sessionScope.locale != null && localeCode.equals(en))}">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown02">
                        <a class="dropdown-item"
                           href="${pageContext.request.contextPath}/controller/setLocale?locale=ua">
                            <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-ua" viewBox="0 0 640 480"
                                 class="flag-icon">
                                <g fill-rule="evenodd" stroke-width="1pt">
                                    <path fill="#ffd500" d="M0 0h640v480H0z"/>
                        ...
                        <a class="dropdown-item"
                           href="${pageContext.request.contextPath}/controller/setLocale?locale=en">
                            <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-us" viewBox="0 0 640 480"
                                 class="flag-icon">
                                <g fill-rule="evenodd">
                                    <g stroke-width="1pt">
                        ...
                        <a class="dropdown-item"
                           href="${pageContext.request.contextPath}/controller/setLocale?locale=ru"
                           style="float: right">
                            <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-ru" viewBox="0 0 640 480"
                                 class="flag-icon">
                                <g fill-rule="evenodd" stroke-width="1pt">
                ...
                <c:if test="${sessionScope.authenticated == null}">
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/controller/login"><fmt:message
                                key="signIn" bundle="${bundle}"/></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/controller/register"><fmt:message
                                key="signup" bundle="${bundle}"/></a>
                    </li>
                </c:if>
                ...
                <c:if test="${sessionScope.authenticated != null && sessionScope.authenticated == true}">
                    <c:if test="${sessionScope.role == 'USER'}">
                        <li class="nav-item">
                            <a class="nav-link ${(uri.length() - path.length()) <= 1 || uri.contains("quizzes") ? "active" : ""}"
                               href="${pageContext.request.contextPath}/controller/user/quizzes">
                                <fmt:message key="quizzes" bundle="${bundle}"/>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${uri.contains("assignments") ? "active" : ""}"
                               href="${pageContext.request.contextPath}/controller/user/assignments">
                                <fmt:message key="assignments" bundle="${bundle}"/>
                            </a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${sessionScope.role == 'ADMIN'}">
                        <li class="nav-item dropdown show">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown01">
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/controller/admin/users">
                                    <fmt:message key="users" bundle="${bundle}"/>
                                </a>
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/controller/admin/quizzes">
                                    <fmt:message key="quizzes" bundle="${bundle}"/>
                                </a>
                            </div>
                        </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/controller/logout"><fmt:message
                                key="signOut" bundle="${bundle}"/></a>
                    </li>
                </c:if>
                <c:if test="${isTest}"><%--@elvariable id="assignment" type="com.example.app.model.assignment.Assignment"--%>
                    <li class="nav-item" style="width: auto">
                        <span id="timer"
                              style="float:right; color: #4af; font-size: 150%; font-weight: bold;">${assignment.quiz.time < 10 ? 0 : ''}${assignment.quiz.time}:00</span>
                    </li>
                </c:if>
...
<div class="container">
    <div class="row alert alert-danger" role="alert"
         style="display: ${sessionScope.blocked != null || errorMessage != null ? "block" : "none"}" id="errorAlert">
    ...
    <div class="row alert alert-info" role="alert" style="display: none;" id="infoAlert">
        <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"><fmt:message key="regMsg"
                                                                                           bundle="${bundle}"/></span>
    </div>
</div>