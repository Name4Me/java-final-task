        ...
        <c:forEach items="${page.items}" var="user">
            <tr id="user_${user.id}">
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-outline-success unblock" data-id="${user.id}"
                            style="display: ${user.userStatus == 'BLOCKED' ? 'initial' : 'none'}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <button type="button" class="btn btn-outline-danger block" data-id="${user.id}"
                            style="display: ${user.userStatus == 'BLOCKED' ? 'none' : 'initial'}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<form action="${pageContext.request.contextPath}/controller/admin/user/update" id="updateForm" style="display: none">
