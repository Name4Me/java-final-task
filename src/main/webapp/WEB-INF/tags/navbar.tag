...
<c:if test="${sessionScope.locale == null}">
    ...
    <c:set var="localeCode" value="ru" />
</c:if>
<c:if test="${sessionScope.locale != null}">
    <fmt:setLocale value="${sessionScope.locale}"/>
    <c:set var="localeCode" value="${sessionScope.locale}" />
</c:if>
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown show">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown02">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/setLocale?locale=ua">
                            <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-ua" viewBox="0 0 640 480" class="flag-icon">
                                <g fill-rule="evenodd" stroke-width="1pt">
                                    <path fill="#ffd500" d="M0 0h640v480H0z"/>
                                    <path fill="#005bbb" d="M0 0h640v240H0z"/>
                        ...
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/setLocale?locale=en">
                            <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-us" viewBox="0 0 640 480" class="flag-icon">
                                <g fill-rule="evenodd">
                                    <g stroke-width="1pt">
                                        <path fill="#bd3d44" d="M0 0h972.8v39.4H0zm0 78.8h972.8v39.4H0zm0 78.7h972.8V197H0zm0 78.8h972.8v39.4H0zm0 78.8h972.8v39.4H0zm0 78.7h972.8v39.4H0zm0 78.8h972.8V512H0z" transform="scale(.9375)"/>
                        ...
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/setLocale?locale=ru" style="float: right">
                            <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-ru" viewBox="0 0 640 480" class="flag-icon">
                                <g fill-rule="evenodd" stroke-width="1pt">
                                    <path fill="#fff" d="M0 0h640v480H0z"/>
                                    <path fill="#0039a6" d="M0 160h640v320H0z"/>
